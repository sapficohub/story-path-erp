  ...
  head: () => ({
    meta: [
      { title: "SAP Career Journeys | Next-Gen ERP" },
      {
        name: "description",
        content:
          "Explore practical SAP career journeys for freshers, experienced professionals and career-gap candidates through interactive success stories.",
      },
...
const J = [
  {
    ...
    desc: "From graduation to first SAP job. 15 chapters of transformation.",
    icon: GraduationCap,
    emoji: "🎓",
        ...
        <section className="bg-gradient-hero py-20">
          <div className="mx-auto max-w-5xl px-4 text-center">
            ...
            <h1 className="mt-4 text-4xl font-black md:text-6xl">
              Three stories. <span className="text-gradient-brand">One transformation.</span>
            </h1>
            <p className="mt-5 mx-auto max-w-3xl text-lg text-muted-foreground">
              Pick the journey that matches your story. Each one is a fully animated comic-style
              chapter book — like a movie you scroll through.
            </p>
          </div>
        </section>
        <section className="mx-auto max-w-7xl px-4 py-16 grid gap-6 md:grid-cols-3">
          {J.map((j, i) => (
            ...
            >
              ...
              >
                <div
                  className={`absolute -right-20 -top-20 h-48 w-48 rounded-full bg-gradient-to-br ${j.color} opacity-30 blur-3xl`}
                />
                <div className="relative">
                  <div className="text-6xl">{j.emoji}</div>
                  <div className="mt-2 text-xs font-bold uppercase tracking-widest text-brand">
                    Meet {j.name}
                  </div>
