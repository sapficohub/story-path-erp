...
import { localBusinessSchema, webPageSchema, breadcrumbSchema, SITE_URL } from "@/lib/schema";
export const Route = createFileRoute("/")({
  head: () => ({
    ...
    meta: [
      ...
      {
        property: "og:title",
        content: "Best SAP Training Institute in Hyderabad | Next-Gen ERP Solutions",
      },
      {
      ...
      },
      {
        ...
        content: "Next-Gen ERP Solutions - SAP Training & Placement Institute",
      },
      {
        property: "og:locale",
        content: "en_IN",
      ...
      },
      {
        ...
        content: "Industry-oriented SAP Training with real-time projects and placement assistance.",
      },
      {
        name: "twitter:image",
        content:
...
const JOURNEYS = [
  {
    ...
    emoji: "🎓",
    title: "Fresher",
    desc: "Build practical SAP knowledge, complete guided projects and prepare confidently for your first professional role.",
  ...
  },
  {
    ...
    desc: "Connect your industry experience with specialised SAP skills to pursue stronger roles and long-term career growth.",
  ...
  },
  {
    ...
    emoji: "🔄",
    title: "Career Gap",
    desc: "Refresh your professional knowledge through structured SAP learning and prepare for a confident return to work.",
...
const PROCESS = [
  {
    step: "01",
    title: "Enroll",
    desc: "Attend a free demo and select the SAP module that matches your career goals.",
  },
  {
    step: "02",
    title: "Train",
    desc: "Learn through instructor-led classes while practising directly on a live SAP server.",
  },
  {
    step: "03",
    title: "Projects",
    desc: "Apply your knowledge through realistic SAP implementation projects and connected business scenarios.",
  },
  {
    step: "04",
    title: "Interview",
    desc: "Strengthen your resume, communication and interview performance through structured practice.",
  },
  {
    step: "05",
    title: "Placement",
    desc: "Receive placement assistance and updates about opportunities relevant to your skills and eligibility.",
  },
  {
    step: "06",
    title: "Growth",
    desc: "Continue developing your SAP knowledge through career guidance and focused professional learning.",
  },
];
      ...
      <SiteLayout>
        ...
        <section className="relative overflow-hidden bg-gradient-hero">
          ...
          <div className="relative mx-auto grid w-full max-w-7xl items-center gap-12 px-4 py-16 md:grid-cols-2 md:gap-10 md:py-24">
            <div className="min-w-0">
              ...
              >
                Our SAP training in Hyderabad is designed for career-focused learners who want
                practical knowledge, live server experience and structured interview preparation.
                Next-Gen ERP Solutions helps graduates, working professionals and career restart
                candidates develop job-ready SAP skills through trainer-led classes and real-time
                business scenarios.
              </motion.p>
              <motion.div
                initial={{ opacity: 0, y: 20 }}
              ...
              >
                <Link
                  to="/contact"
                  className="inline-flex min-h-12 items-center justify-center gap-2 rounded-full bg-gradient-brand px-5 py-3 font-semibold text-white shadow-glow transition hover:scale-105 max-[375px]:w-full"
                >
                  Book Free Demo <ArrowRight className="h-4 w-4" />
                </Link>
                <Link
                  to="/contact"
                  className="inline-flex min-h-12 items-center justify-center gap-2 rounded-full border-2 border-brand bg-white px-5 py-3 font-semibold text-brand transition hover:bg-brand hover:text-white max-[375px]:w-full"
                >
                  <Phone className="h-4 w-4" /> Talk To Career Advisor
                </Link>
                <Link
                  to="/career-journeys"
                  className="inline-flex min-h-12 items-center justify-center gap-2 rounded-full bg-brand-dark px-5 py-3 font-semibold text-white transition hover:opacity-90 max-[375px]:w-full"
                >
                  Explore Journeys
                </Link>
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex min-h-12 items-center justify-center gap-2 rounded-full bg-[#25D366] px-5 py-3 font-semibold text-white transition hover:scale-105 max-[375px]:w-full"
                >
            ...
            >
              ...
              {/* floating chips */}
              <FloatingChip className="-left-6 top-10" delay={0.2}>
                SAP S/4HANA
              </FloatingChip>
              <FloatingChip className="-right-4 top-32" delay={0.5}>
                FICO ★ MM ★ SD
              </FloatingChip>
              <FloatingChip className="bottom-4 -left-4" delay={0.8}>
                Career Support
              </FloatingChip>
            </motion.div>
          </div>
        ...
        <section className="mx-auto max-w-5xl px-4 py-20">
          ...
          <div className="mt-10 space-y-6 text-base leading-8 text-muted-foreground">
            <p>
              Next-Gen ERP Solutions provides practical SAP training in Hyderabad for graduates,
              working professionals and career-restart candidates. Learners receive guided
              instruction, live server practice, real-time project exposure and interview
              preparation across major SAP modules.
            </p>
            <p>
              Our training approach focuses on understanding business processes before applying them
              in SAP. Students practise configuration, transaction processing, testing and
              troubleshooting so they can explain both functional concepts and practical scenarios
              during interviews.
            </p>
            <p>
              Career support includes resume guidance, mock interviews, profile-building assistance
              and updates about relevant opportunities. Placement assistance supports the job-search
              process, while employment outcomes depend on each learner's skills, performance,
              eligibility and current hiring conditions.
            </p>
          </div>
        </section>
        ...
        <section className="mx-auto max-w-7xl px-4 py-20">
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-3">
            {JOURNEYS.map((j, i) => (
              ...
              >
                <div
                  className={`absolute -right-10 -top-10 h-40 w-40 rounded-full bg-gradient-to-br ${j.color} opacity-20 blur-2xl transition group-hover:opacity-40`}
                />
        ...
        <section className="mx-auto max-w-7xl px-4 py-20">
          <SectionHeader
            ...
            title="Practical SAP Courses with Live Server Access"
          />
          <div className="mt-12 grid gap-6 md:grid-cols-3">
            {[
              {
        ...
        <section className="mx-auto max-w-7xl px-4 py-20">
          <SectionHeader
            ...
            title="Interview Preparation and Placement Assistance"
          />
            ...
            {TESTIMONIALS.map((s, i) => (
              ...
              >
                <div className="flex items-center gap-3">
                  <div className="flex h-12 w-12 items-center justify-center rounded-full bg-gradient-brand font-black text-white">
                    {s.n[0]}
                  </div>
                  <div>
                ...
                <p className="mt-4 text-sm italic text-muted-foreground">“{s.q}”</p>
              </motion.div>
            ))}
          </div>
        </section>
          ...
          <div className="mx-auto grid max-w-7xl items-center gap-10 px-4 md:grid-cols-2">
            <div>
              ...
              <p className="mt-4 text-lg text-muted-foreground">
                Build practical SAP skills with expert guidance, live server exercises and
                structured career support. Speak with a career advisor to discuss the learning path
