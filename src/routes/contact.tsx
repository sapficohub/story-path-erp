...
head: () => ({
  ...
  meta: [
...

    {
      ...
      content:
        "Book a free SAP demo, career counselling or contact our placement team.",
    },
...

    {
      ...
      content:
        "Reach our SAP training experts for admissions and career guidance.",
    },
    ...
    <SiteLayout>
      <section className="bg-gradient-hero py-20">
        <div className="mx-auto max-w-5xl px-4 text-center">
          ...
          <p className="mx-auto mt-5 max-w-3xl text-lg text-muted-foreground">Career advisors available 9am – 9pm IST. WhatsApp replies within minutes.</p>
        </div>
      </section>
        ...
        <div className="space-y-4">
          ...
          <div className="rounded-2xl border border-border bg-card p-5 shadow-card">
            ...
            <div className="mt-3 flex gap-3">
              <a aria-label="YouTube" href="https://www.youtube.com/@Next-GenERPSolutions" target="_blank" rel="noreferrer" className="rounded-full bg-secondary p-3 transition hover:bg-brand hover:text-white"><Youtube className="h-5 w-5" /></a>
              <a aria-label="Instagram" href="https://www.instagram.com/nextgenerpsolutions/" target="_blank" rel="noreferrer" className="rounded-full bg-secondary p-3 transition hover:bg-brand hover:text-white"><Instagram className="h-5 w-5" /></a>
              <a aria-label="Facebook" href="https://www.facebook.com/NextGenERPSolutions" target="_blank" rel="noreferrer" className="rounded-full bg-secondary p-3 transition hover:bg-brand hover:text-white"><Facebook className="h-5 w-5" /></a>
            </div>
          </div>
