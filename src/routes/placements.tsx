  ...
  head: () => ({
    ...
    meta: [
      { title: "SAP Placement Assistance Hyderabad | Next-Gen ERP" },
      {
        name: "description",
        content:
          "Explore SAP placement assistance, interview preparation, student success stories and career support offered by Next-Gen ERP Solutions.",
      },
        ...
        <section className="bg-gradient-hero py-20">
          <div className="mx-auto max-w-5xl px-4 text-center">
            ...
            <h1 className="mt-4 text-4xl font-black md:text-6xl">
              Where our students <span className="text-gradient-brand">land</span>
            </h1>
            <p className="mt-5 mx-auto max-w-3xl text-lg text-muted-foreground">
              A dedicated placement cell, 120+ hiring partners and a 92% placement record. We don't
              stop until you sign your offer letter.
            </p>
          </div>
        </section>
