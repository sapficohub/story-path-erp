  ...
  head: () => ({
    meta: [
      { title: "SAP Student Success Stories | Next-Gen ERP" },
      {
        name: "description",
        content:
          "Read genuine SAP student success stories, career transitions and placement outcomes achieved with practical training and dedicated support.",
      },
        ...
        <section className="bg-gradient-hero py-20">
          <div className="mx-auto max-w-5xl px-4 text-center">
            ...
            <h1 className="mt-4 text-4xl font-black md:text-6xl">
              Real careers. <span className="text-gradient-brand">Real numbers.</span>
            </h1>
            <p className="mt-5 mx-auto max-w-3xl text-lg text-muted-foreground">
              Every story is verified. Every number is real. Every transformation began with one
              decision.
            </p>
          </div>
        </section>
          ...
          {STORIES.map((s, i) => (
            ...
            >
              <div className="flex items-center gap-3">
                <div className="flex h-14 w-14 items-center justify-center rounded-full bg-gradient-brand text-xl font-black text-white">
                  {s.n[0]}
                </div>
                <div>
              ...
              <div className="mt-4 grid grid-cols-2 gap-2 text-xs">
                ...
                <div className="rounded-lg bg-brand-green/10 p-2">
                  <b className="text-brand-green">After:</b>
                  <br />
                  {s.a}
                </div>
              </div>
