...
head: () => ({
  ...
  meta: [
...

    {
      ...
      content:
        "Learn more about our SAP training institute and placement programs.",
    },
    ...
    <SiteLayout>
      ...
      <section className="mx-auto grid max-w-6xl gap-8 px-4 py-16 md:grid-cols-3">
        {[
          ...
          >
            <div className="inline-flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-brand text-white"><card.i className="h-6 w-6" /></div>
      ...
      <section className="bg-secondary py-16">
        <div className="mx-auto max-w-6xl px-4">
          <h2 className="text-center text-3xl font-black md:text-4xl">Our Training Methodology</h2>
          <div className="mt-10 grid gap-5 md:grid-cols-4">
            {["Live Instructor-Led Classes", "Real SAP Server Access", "Industry-Grade Projects", "Mock Interviews & Placement"].map((step, index) => (
              <div key={step} className="rounded-xl border-2 border-brand-dark bg-card p-5 shadow-[4px_4px_0_#071126]">
      ...
      <section className="mx-auto max-w-7xl px-4 py-16">
        <h2 className="text-center text-3xl font-black md:text-4xl">Transformation by the numbers</h2>
        <div className="mt-10 grid gap-6 md:grid-cols-4">
          {[
            ...
            <div key={stat.t} className="rounded-2xl border border-border bg-card p-6 text-center shadow-card">
