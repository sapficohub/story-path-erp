      ...
      <div className="mx-auto grid max-w-7xl gap-10 px-4 py-14 md:grid-cols-4">
        <div className="space-y-4">
          ...
          <p className="text-sm text-white/70">
            SAP training, certification guidance and placement support for freshers, experienced
            professionals and career-gap candidates.
          </p>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li>
              <Link to="/career-journeys" className="hover:text-white">
                Career Journeys
              </Link>
            </li>
            <li>
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm">
            <li className="flex items-center gap-2">
              ...
              <a href="tel:+919000333859">+91 90003 33859</a>
            </li>
            <li className="flex items-center gap-2">
              <MessageCircle className="h-4 w-4 text-brand-green" />{" "}
              <a href="https://wa.me/919000333859" target="_blank" rel="noreferrer">
                WhatsApp Chat
              </a>
            </li>
            <li className="flex items-start gap-2">
              <MapPin className="h-4 w-4 text-brand-teal mt-0.5" /> Hyderabad, India
            </li>
          </ul>
        </div>
      </div>
