    ...
    >
      ...
      >
        ...
        <motion.g
          ...
          transition={{ duration: 4, repeat: Infinity, times: [0, 0.96, 0.98, 1] }}
...
export function SalaryGraph({ growth = 1 }: { growth?: number }) {
  ...
  return (
    <svg viewBox="0 0 180 110" className="h-full w-full">
      ...
      {[0, 1, 2, 3].map((i) => (
        <line key={i} x1="10" x2="170" y1={20 + i * 20} y2={20 + i * 20} stroke="#e2e8f0" />
      ))}
      <motion.polyline
      ...
      <text x="10" y="105" fontSize="8" fill="#64748B">
        Year 1
      </text>
      <text x="148" y="105" fontSize="8" fill="#64748B">
        Year 5
      </text>
    </svg>
  );
