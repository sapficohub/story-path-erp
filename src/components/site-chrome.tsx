    ...
    >
      <div className="mx-auto max-w-7xl px-6 h-16 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-8 text-sm font-medium">
          ...
          <Link to="/journey/fresher" className={linkBase}>
            Fresher
          </Link>
          <Link to="/journey/experienced" className={linkBase}>
            Professional
          </Link>
          <Link to="/journey/career-gap" className={linkBase}>
            Career Gap
          </Link>
        </nav>
        <motion.a
      ...
      <div className="mx-auto max-w-7xl grid md:grid-cols-4 gap-10">
        <div>
          ...
          <p className="mt-4 text-sm text-white/60">
            Premium SAP training and placement support for ambitious learners.
          </p>
        </div>
        <div>
          ...
          <ul className="space-y-2 text-sm text-white/70">
            <li>
              <Link to="/journey/fresher" className="hover:text-white">
                For Freshers
              </Link>
            </li>
            <li>
              <Link to="/journey/experienced" className="hover:text-white">
                For Professionals
              </Link>
            </li>
            <li>
              <Link to="/journey/career-gap" className="hover:text-white">
                After Career Gap
              </Link>
            </li>
          </ul>
