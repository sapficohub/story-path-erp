...
import { a as useMotionValueEvent, i as useScroll, n as useSpring, o as motion, r as useTransform } from "../_libs/framer-motion.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/chapter-visuals-ry-JTUyz.js
...
function ChapterPanel({ chapter, index, total }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute inset-0 -z-10 grid-bg opacity-30" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
...
function ProgressTracker({ chapters }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			className: "scroll-progress-bar h-1 bg-growth"
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					"data-progress": Math.round(val / 5) * 5,
					className: "progress-fill h-full bg-growth"
				})
			})]
		})
	});
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", {
						...
						{
							positionClassName: "journey-character-arjun",
							color: "#1686F5",
							name: "Arjun",
							tag: "Fresher",
							delay: .6
						...
						{
							positionClassName: "journey-character-rahul",
							color: "#19C7D8",
							name: "Rahul",
							tag: "Experienced",
							delay: .9
						...
						{
							positionClassName: "journey-character-priya",
							color: "#E94B8C",
							name: "Priya",
							tag: "Restart",
							delay: 1.2
						...
						className: `absolute -translate-x-1/2 ${c.positionClassName}`,
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
...
var SoftGrid = () => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "soft-grid absolute inset-0 opacity-30" });
var FresherVisuals = {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: [
					...
					className: `relative h-[130px] w-20 ${i === 1 ? "" : "opacity-50"}`,
	...
	offerLetter: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Panel, {
		...
		children: [
			...
			Array.from({ length: 15 }).map((_, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(motion.div, {
				...
				className: `chapter-confetti chapter-confetti-${i + 1} absolute w-2 h-2 rounded-sm`
			}, i))
		]
	}),
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: [
					...
					transition: { delay: i * .15 },
					className: `relative h-[110px] w-16 ${i === 3 ? "opacity-[0.45]" : ""}`,
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Character, {
						mood: i === 3 ? "sad" : "happy",
						color: i === 3 ? "#1686F5" : [
							"#09B83E",
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(motion.div, {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						"resume-bar-40",
						"resume-bar-70"
					].map((barClass) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: `h-1.5 bg-white/30 rounded mb-1.5 ${barClass}` }, barClass))]
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(motion.div, {
					initial: {
						x: 30,
						opacity: 0
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						"resume-bar-80",
						"resume-bar-90-after"
					].map((barClass) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: `h-1.5 bg-[#1686F5] rounded mb-1.5 ${barClass}` }, barClass))]
				})]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
	...
	selfDoubt: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Panel, {
		...
		children: [
			...
			[
				...
				className: `career-question-bubble career-question-bubble-${i + 1} absolute comic-bubble text-xs`,
				children: q
			}, q))
		]
	}),
