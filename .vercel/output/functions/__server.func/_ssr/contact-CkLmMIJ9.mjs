...
import { d as Phone, f as MessageCircle, g as Instagram, h as Mail, m as MapPin, t as Youtube, y as Facebook } from "../_libs/lucide-react.mjs";
import { n as SiteLayout } from "./SiteLayout-CPmyeztc.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/contact-CkLmMIJ9.js
...
function ContactPage() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SiteLayout, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
		...
		className: "mx-auto max-w-7xl px-4 py-16 grid gap-10 lg:grid-cols-[1fr_1.2fr]",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "space-y-4",
			children: [
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", {
								...
								target: "_blank",
								rel: "noreferrer",
								className: "rounded-full bg-secondary p-3 hover:bg-brand hover:text-white transition",
