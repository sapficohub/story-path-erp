...
var Route$16 = createRootRouteWithContext()({
	head: () => ({
		...
		meta: [
			...
			{
				name: "description",
				content: "Next-Gen ERP Solutions offers SAP Training, real-time projects, certification guidance and placement assistance for freshers, experienced professionals and career-gap candidates."
			},
			{
				name: "keywords",
				content: "SAP Training, SAP FICO, SAP MM, SAP SD, SAP ABAP, SAP BASIS, SAP HCM, SAP SuccessFactors, SAP Course, SAP Institute Hyderabad, ERP Training"
			},
			{
				name: "robots",
...
function RootShell({ children }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("html", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("head", { children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(JsonLd, { data: organizationSchema }),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(JsonLd, { data: websiteSchema })
...
var $$splitComponentImporter$14 = () => import("./success-stories-CpIfW10x.mjs");
...
var BASE_URL = "https://www.next-generpsolutions.com";
...
var $$splitComponentImporter$13 = () => import("./quiz-BAcaeYLf.mjs");
...
var Route$9 = createFileRoute("/contact")({
	head: () => ({
		...
		meta: [
			{ title: "Contact Next-Gen ERP Solutions | SAP Training & Placement" },
			{
				name: "description",
				content: "Contact Next-Gen ERP Solutions for SAP training, free demo sessions, career counselling, placement support and admission enquiries."
			},
			{
				name: "keywords",
				content: "Contact SAP Institute Hyderabad, SAP Training Contact, SAP Placement Support, SAP Demo Class Hyderabad"
			},
			{
				name: "robots",
				content: "index,follow,max-image-preview:large,max-snippet:-1,max-video-preview:-1"
...
var $$splitComponentImporter$8 = () => import("./career-journeys-CPCfZFoh.mjs");
...
var $$splitComponentImporter$6 = () => import("./blog-BDxFdDME.mjs");
...
var Route$5 = createFileRoute("/about")({
	head: () => ({
		...
		meta: [
			{ title: "About Next-Gen ERP Solutions | SAP Training & Placement Institute" },
			{
				name: "description",
				content: "Learn about Next-Gen ERP Solutions, our SAP training methodology, placement support, experienced trainers and our mission to build successful SAP careers."
			},
			{
				name: "keywords",
				content: "About Next-Gen ERP Solutions, SAP Institute Hyderabad, SAP Training Institute, SAP Placement Institute"
			},
			{
				name: "robots",
				content: "index,follow,max-image-preview:large,max-snippet:-1,max-video-preview:-1"
			...
			{
				property: "og:description",
				content: "Discover our SAP training methodology, placement support and career transformation journey."
			},
			{
				property: "og:url",
...
var Route$4 = createFileRoute("/")({
	head: () => ({
		...
		meta: [
			{ title: "Best SAP Training Institute in Hyderabad | SAP FICO, MM, SD, ABAP Courses | Next-Gen ERP Solutions" },
			{
				name: "description",
				content: "Join Next-Gen ERP Solutions, one of the leading SAP Training Institutes in Hyderabad. Learn SAP FICO, MM, SD, ABAP, BASIS, HCM and SuccessFactors with real-time projects, live SAP server access and placement assistance."
			},
			{
				name: "keywords",
				content: "SAP Training Hyderabad, SAP FICO Training, SAP MM Training, SAP SD Training, SAP ABAP Training, SAP BASIS Training, SAP HCM Training, SAP SuccessFactors Training, SAP Institute Hyderabad, SAP Course, SAP Certification, SAP Placement"
			},
			{
				name: "robots",
				content: "index,follow,max-image-preview:large,max-snippet:-1,max-video-preview:-1"
			...
			{
				property: "og:description",
				content: "Master SAP with live projects, certified trainers, interview preparation and placement assistance."
			},
			{
				property: "og:url",
				content: "https://www.next-generpsolutions.com/"
...
var $$splitComponentImporter$3 = () => import("./courses.index-BQ6n0sE0.mjs");
var Route$3 = createFileRoute("/courses/")({
	head: () => ({
		...
		meta: [
			{ title: "SAP Courses in Hyderabad | SAP FICO, MM, SD, ABAP & More | Next-Gen ERP Solutions" },
			{
				name: "description",
				content: "Explore SAP FICO, MM, SD, ABAP, BASIS, HCM and SuccessFactors courses with real-time projects, live SAP server access and placement assistance."
			},
			{
				name: "keywords",
				content: "SAP Courses Hyderabad, SAP FICO Course, SAP MM Course, SAP SD Course, SAP ABAP Course, SAP BASIS Course, SAP HCM Course, SAP SuccessFactors Course"
			},
			{
				name: "robots",
				content: "index,follow,max-image-preview:large,max-snippet:-1,max-video-preview:-1"
...
var $$splitComponentImporter$2 = () => import("./journey.fresher-By-a_PwL.mjs");
...
var $$splitComponentImporter$1 = () => import("./journey.experienced-DH4hE-rr.mjs");
...
var $$splitComponentImporter = () => import("./journey.career-gap-CvkDY6yx.mjs");
