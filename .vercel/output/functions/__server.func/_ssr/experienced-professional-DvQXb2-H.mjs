...
import { n as JourneyHero, t as FinalCTA } from "./fresher-journey-kiJSgIhI.mjs";
import { t as ComicPanel } from "./ComicPanel-ClrGAn44.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/experienced-professional-DvQXb2-H.js
...
function ExperiencedJourney() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SiteLayout, { children: [
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)(motion.div, {
			...
			className: "fixed left-0 top-[64px] z-30 h-1 w-full origin-left bg-gradient-brand"
		}),
