...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-C2FnS7Jq.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-C0OZiwR_.mjs"),
		import("./start-CcxFwyvK.mjs"),
		import("./empty-plugin-adapters-i5_TS8is.mjs")
	]);
	return {
		routerEntry,
		startEntry,
