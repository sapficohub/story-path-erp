...
//#region node_modules/.nitro/vite/services/ssr/assets/SiteLayout-CJeBVsZS.js
...
function SiteHeader({ dark = false }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
		className: dark ? "sticky top-0 z-40 border-b border-white/10 bg-brand-dark/85 text-white backdrop-blur-xl" : "sticky top-0 z-40 border-b border-border/60 bg-background/85 backdrop-blur-xl",
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("nav", {
					...
					children: NAV.map((n) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
						to: n.to,
						className: dark ? "rounded-full px-3 py-2 text-sm font-medium text-white/80 transition hover:bg-white/10 hover:text-white" : "rounded-full px-3 py-2 text-sm font-medium text-foreground/80 transition hover:bg-secondary hover:text-foreground",
						activeProps: { className: dark ? "rounded-full px-3 py-2 text-sm font-semibold text-white bg-white/10" : "rounded-full px-3 py-2 text-sm font-semibold text-brand bg-secondary" },
						children: n.label
					}, n.to))
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", {
						...
						className: dark ? "text-sm font-semibold text-white" : "text-sm font-semibold text-brand",
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
					...
					"aria-label": "Menu",
					className: dark ? "lg:hidden inline-flex h-10 w-10 items-center justify-center rounded-full border border-white/20" : "lg:hidden inline-flex h-10 w-10 items-center justify-center rounded-full border border-border",
					children: open ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(X, { className: "h-5 w-5" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Menu, { className: "h-5 w-5" })
				})
			]
		}), open && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: dark ? "lg:hidden border-t border-white/10 bg-brand-dark" : "lg:hidden border-t border-border bg-background",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("nav", {
				className: "mx-auto flex max-w-7xl flex-col gap-1 px-4 py-3",
				children: [NAV.map((n) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
					to: n.to,
					onClick: () => setOpen(false),
					className: dark ? "rounded-lg px-3 py-2.5 text-sm font-medium text-white/80 hover:bg-white/10" : "rounded-lg px-3 py-2.5 text-sm font-medium text-foreground/80 hover:bg-secondary",
					children: n.label
...
function SiteLayout({ children, dark = false }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "flex min-h-screen flex-col",
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SiteHeader, { dark }),
