...
import { t as createMiddleware } from "./createMiddleware-QJAdXRy1.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BePUvWVt.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-LpDTl4X2.mjs"),
		import("./start-BYeqFURP.mjs"),
		import("./empty-plugin-adapters-BJphw5kG.mjs")
	]);
	return {
		routerEntry,
		startEntry,
