import{d as e}from"./useStore-Cbq7rcj4.js";import{t}from"./SiteLayout-1bIhYgKx.js";var n=`<!DOCTYPE html>\r
<html lang="en">\r
<head>\r
...
\r
    .sap-chip:nth-child(1) { --x: 7%; --dur: 22s; --delay: -2s; }\r
    .sap-chip:nth-child(2) { --x: 18%; --dur: 28s; --delay: -12s; }\r
    .sap-chip:nth-child(3) { --x: 31%; --dur: 24s; --delay: -6s; }\r
    .sap-chip:nth-child(4) { --x: 45%; --dur: 30s; --delay: -18s; }\r
    .sap-chip:nth-child(5) { --x: 58%; --dur: 25s; --delay: -9s; }\r
    .sap-chip:nth-child(6) { --x: 72%; --dur: 32s; --delay: -16s; }\r
    .sap-chip:nth-child(7) { --x: 84%; --dur: 26s; --delay: -4s; }\r
    .sap-chip:nth-child(8) { --x: 12%; --dur: 34s; --delay: -24s; }\r
    .sap-chip:nth-child(9) { --x: 65%; --dur: 29s; --delay: -22s; }\r
    .sap-chip:nth-child(10) { --x: 91%; --dur: 23s; --delay: -11s; }\r
\r
...
\r
    ...
    .question-type-label { color: #38bdf8; font-weight: 700; }\r
...
<div class="sap-bg" aria-hidden="true">\r
  <span class="sap-chip">SAP</span>\r
  <span class="sap-chip">FICO</span>\r
  <span class="sap-chip">GL</span>\r
  <span class="sap-chip">FS00</span>\r
  <span class="sap-chip">OB52</span>\r
  <span class="sap-chip">ACDOCA</span>\r
  <span class="sap-chip">LEDGER</span>\r
  <span class="sap-chip">FI</span>\r
  <span class="sap-chip">CO</span>\r
  <span class="sap-chip">K4</span>\r
</div>\r
\r
<!-- Oops Popup Overlay -->\r
...
<div class="quiz-hero" id="quiz-hero">\r
  ...
  <div class="hero-progress-track">\r
    <div class="hero-progress-fill" id="hero-fill"></div>\r
  </div>\r
...
const QUESTIONS = [\r
  ...
  {\r
    ...
    "q": "Many types of Chart of Accounts are available in SAP FI?",\r
    "fact": "3",\r
    "opts": [\r
      "2",\r
      "3",\r
...
\r
  const typeTag = q.type === 'yn'\r
    ? '<span class="question-type-label">Yes / No</span>'\r
    : '<span class="question-type-label">Multiple Choice</span>';\r
\r
  root.innerHTML = \`\r
